<template>
  <div class="has-background-neutral-050">
    <the-navbar v-show="shouldShowNav" @click:tutorials-button="showMain" @click:logo="onClickLogo"></the-navbar>
    <tutorials-page v-show="shouldTutorialsPage" @click:close="onTutorialsClickClose" @click:add="onClickAdd" @select="onSelect"></tutorials-page>
    <tutorial-page v-show="shouldTutorialPage" @click:close="onTutorialClickClose"></tutorial-page>
  </div>
</template>
<script>
