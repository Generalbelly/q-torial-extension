  ...
  return (function(t) {
      ...
      ;(n(9).inspectSource = function(t) {
        ...
        (t.exports = function(t, e, n, a) {
          ...
          l && (r(n, 'name') || i(n, 'name', e)),
            t[e] !== n &&
              (l && (r(n, s) || i(n, s, t[e] ? '' + t[e] : c.join(String(e)))),
              t === o
                ? (t[e] = n)
                : a
                ? t[e]
    ...
    function(t, e, n) {
      ...
      var o = n(2),
        ...
        J = function(t) {
          ...
          return (
            !(this === z && i(I, t) && !i(R, t)) &&
            (!(e || !i(this, t) || !i(I, t) || (i(this, H) && this[H][t])) || e)
          )
        },
        X = function(t, e) {
          if (((t = w(t)), (e = x(e, !0)), t !== z || !i(I, e) || i(R, e))) {
            var n = L(t, e)
            return (
              !n || !i(I, e) || (i(t, H) && t[H][e]) || (n.enumerable = !0), n
            )
          }
        },
        Q = function(t) {
    ...
    function(t, e, n) {
      ...
      t.exports = function(t, e, n, p, v, y, g) {
        ...
        if (
          (T &&
            (w = u(T.call(new t()))) !== Object.prototype &&
            w.next &&
            (l(w, k, !0), o || 'function' == typeof w[h] || s(w, h, d)),
          S &&
            E &&
            'values' !== E.name &&
            ((O = !0),
        ...
        var e =
          ...
          l = function(t) {
            var r = t.actions
              ...
              l = e({}, c, t.classes),
              u = t.defaultParagraphSeparator || 'div',
              h = i('div')
            ;(h.className = l.actionbar), o(t.element, h)
            var f = (t.element.content = i('div'))
            return (
              (f.contentEditable = !0),
              (f.className = l.content),
              ...
              r.forEach(function(t) {
                ...
                if (
                  ...
                  var r = function() {
                    return e.classList[t.state() ? 'add' : 'remove'](l.selected)
                  }
        ...
        'Array',
        {
          from: function(t) {
            ...
            if (
              ...
              for (n = new d((e = c(f.length))); e > g; g++)
                l(n, g, y ? v(f[g], g) : f[g])
            else
              for (h = m.call(f), n = new d(); !(i = h.next()).done; g++)
                l(n, g, y ? s(h, v, [i.value, g], !0) : i.value)
            return (n.length = g), n
          },
        }
      )
              ...
              },
              {
                ...
                value: function() {
                  for (
                    ...
                    t && t.tagName && 'body' !== t.tagName.toLowerCase();
              ...
              value: function(t) {
                if ((this.attachNode(), this.setInitialStyle(), t)) {
                  ...
                  (this.node.style.display = 'block'),
                    ...
                    (this.node.style.backgroundColor = this.options.stageBackground),
                    (this.node.style.outline = 'rgba(0, 0, 0, 0.75) solid '.concat(
                      this.getFullPageSize().height,
                      'px'
                    ))
              },
            },
            ...
            },
            {
              ...
              value: function(t) {
                ...
                if ('modal' !== t && (!t || (r && !t.element)))
                  throw new Error('Element is required in step '.concat(n))
                r && ((i = t.element), (o = I({}, this.options, t)))
                var s = 'modal'
                if (
                  'modal' !== t.element &&
                  !(s = y(i) ? i : this.document.querySelector(i))
                )
                  return (
                    console.warn(
                ...
                if (o.popover && o.popover.content) {
                  ...
                  a = new C(l, this.window, this.document)
                }
                var u = I({}, o),
                  h = new F(u, this.window, this.document)
                return new k({
                  node: s,
                  options: o,
                  popover: a,
