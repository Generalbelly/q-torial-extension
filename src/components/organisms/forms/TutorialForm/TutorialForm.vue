  ...
  <div>
    <form-section-layout>
      <template slot="form">
        ...
        <validatable-textarea-field label="Description" v-model="innerDescription" placeholder="Tutorial for first time customers." name="description">
    ...
    <form-section-layout>
      <template slot="form">
        ...
        <columns v-if="innerPath.value !== '/'">
          <column>
            <checkbox :value="innerPath.regex" @input="updateInnerPath('regex', $event)">
...
import FormSectionLayout from '../../../molecules/layouts/FormSectionLayout/FormSectionLayout';
import Columns from '../../../atoms/BaseColumns';
import Column from '../../../atoms/BaseColumn';
import ParameterFields from '../../../molecules/fields/ParameterFields';
import TextField from '../../../atoms/fields/TextField/TextField';
import Checkbox from '../../../atoms/fields/CheckboxField/CheckboxField';
